...
Input Method
#+begin_src emacs-lisp
  (lemon/ensure-package 'pyim)
  (lemon/ensure-package 'pyim-basedict)
  (lemon/ensure-package 'popup)
  (require 'pyim)
...
#+begin_src emacs-lisp
  ...
  (lemon/ensure-package 'utop)
  (require 'utop)

  (add-to-list 'load-path "opam-location/.opam/default/share/emacs/site-lisp")
  (require 'ocp-indent)

  (lemon/ensure-package 'ocaml-eglot)
  (autoload #'ocaml-eglot "ocaml-eglot" nil t)
  (autoload #'eglot-ensure "ocaml-eglot" nil t)
